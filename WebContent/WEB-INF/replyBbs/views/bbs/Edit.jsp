  	...
  	<div class="container">
	    ...
	    <div class="container"><!-- 내용 시작 -->
	    	<div class="page-header">
		  		<h1>답변형 게시판 프로젝트<small>수정 페이지</small></h1>
			</div>			
			<div class="row">					
					<form class="form-horizontal" method="post" action="<c:url value='/ReplyBBS/BBS/Edit.bbs'/>">
						 <input type="hidden" name="no" value="${record.no}"/>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-5">
						    	<textarea rows="10" placeholder="비밀번호를 입력하세요" class="form-control"  id="content" name="content">${record.content}</textarea>						    	
						    </div>
						  </div>
						  <div class="form-group">
