  	...
  	<div class="container">
	    ...
	    <div class="container"><!-- 내용 시작 -->
	    	<div class="page-header">
		  		<h1>답변형 게시판 프로젝트<small>답변작성 페이지</small></h1>
			</div>			
			<div class="row">					
					<form class="form-horizontal" method="post" action="<c:url value='/ReplyBBS/BBS/Reply.bbs'/>">
						 ...
						 <!-- 답글 작성 실패시 다시 답변폼으로 올때 기존 글 내용 뿌려주기 위함 -->
						 <input type="hidden" name="no" value="${record.no}"/>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-5">
<textarea rows="10" placeholder="비밀번호를 입력하세요" class="form-control"  id="content" name="content">
